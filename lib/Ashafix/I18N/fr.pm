...
pDelete_delete_error => '<span class="error_msg">Impossible d\'effacer cette entrée ',
pDelete_delete_success => '%s supprimé.',
pDelete_postdelete_error => '<span class="error_msg">Impossible d\'effacer ce compte courriel',
pDelete_domain_error => '<span class="error_msg">Ce domaine n\'est pas le votre ',
pDelete_domain_alias_error => '<span class="error_msg">Ce domaine n\'est pas le votre ',
pDelete_alias_error => '<span class="error_msg">Impossible d\'effacer cet alias ',
...
pCreate_alias_address_text_error1 => '<br><span class="error_msg">Cet ALIAS n\'est pas valide!</span>',
pCreate_alias_address_text_error2 => '<br><span class="error_msg">Ce compte courriel existe déjà, choisissez un autre libellé !</span>',
pCreate_alias_address_text_error3 => '<br><span class="error_msg">Vous avez atteint votre limite d\'alias créés !</span>',
...
pCreate_alias_goto_text_error => 'Destinataires des courriels.<br /><span class="error_msg">le champ À contient des erreurs!</span>',
pCreate_alias_result_error => '<span class="error_msg">Impossible d\'ajouter cet alias dans la table !</span>',
pCreate_alias_result_success => 'L\'alias a été ajouté !',
pCreate_alias_catchall_text => 'Pour ajouter un alias global, utilisez "*".<br />Pour un transfert de domaine à domaine, utilisez "*@domain.tld" dans le champs A.',
pEdit_alias_welcome => 'Modifier un alias dans votre domaine.<br>Une entrée par ligne.',
pEdit_alias_address => 'Alias',
pEdit_alias_address_error => '<span class="error_msg">Impossible de localiser l\'alias!</span>',
pEdit_alias_goto => 'À',
pEdit_alias_active => 'Activé',
pEdit_alias_goto_text_error1 => '<span class="error_msg">Vous devez entrer quelques choses dans le champ À</span>',
pEdit_alias_goto_text_error2 => '<span class="error_msg">L\'adresse courriel que vous avez entré est invalide: ',
pEdit_alias_domain_error => '<span class="error_msg">Ce domaine n\'est pas le votre: ',
pEdit_alias_domain_result_error => '<span class="error_msg">Impossible de modifier cet alias de domaine!</span>',
...
pEdit_alias_result_error => '<span class="error_msg">Impossible de modifier cet alias!</span>',
pCreate_mailbox_welcome => 'Ajouter un nouveau compte courriel à votre domaine.',
pCreate_mailbox_username => 'Nom d\'utilisateur',
pCreate_mailbox_username_text_error1 => '<br><span class="error_msg">L\'adresse courriel est invalide!</span>',
pCreate_mailbox_username_text_error2 => '<br><span class="error_msg">Ce compte courriel existe deja ! Entrez une autre adresse courriel !</span>',
pCreate_mailbox_username_text_error3 => '<br><span class="error_msg">Vous avez atteint le nombre maximum de compte courriel !</span>',
...
pCreate_mailbox_password_text_error => 'Mot de passe pour compte POP3/IMAP<br /><span class="error_msg">Les mots de passe ne correspondent pas !<br />ou sont vide !</span>',
pCreate_mailbox_name => 'Nom',
pCreate_mailbox_name_text => 'Nom complet',
pCreate_mailbox_quota => 'Limite',
pCreate_mailbox_quota_text => 'MB',
pCreate_mailbox_quota_text_error => 'MB<br /><span class="error_msg">La limite que vous avez specifie est trop haute!</span>',
...
pCreate_mailbox_result_error => '<span class="error_msg">Impossible d\'ajouter un compte courriel dans la table!</span>',
...
pEdit_mailbox_username_error => '<span class="error_msg">Impossible de localiser le compte courriel!</span>',
pEdit_mailbox_password => 'Nouveau mot de passe',
pEdit_mailbox_password2 => 'Nouveau mot de passe (confirmation)',
pEdit_mailbox_password_text_error => '<span class="error_msg">Le mot de passe entré ne correspond pas!</span>',
pEdit_mailbox_name => 'Nom',
pEdit_mailbox_name_text => 'Nom complet',
pEdit_mailbox_quota => 'Limite',
pEdit_mailbox_quota_text => 'MB',
pEdit_mailbox_quota_text_error => 'MB<br /><span class="error_msg">La limite fournit est trop haute!</span>',
pEdit_mailbox_domain_error => '<span class="error_msg">Ce domaine n\'est pas le votre: ',
pEdit_mailbox_button => 'Modifier un compte courriel',
pEdit_mailbox_result_error => '<span class="error_msg">Impossible de modifier le compte courriel !</span>',
pPassword_welcome => 'Changer votre mot de passe.',
pPassword_admin => 'Entrer',
pPassword_admin_text_error => '<span class="error_msg">Les informations entrées ne correspondent pas a un compte courriel!</span>',
pPassword_password_current => 'Mot de passe actuel',
pPassword_password_current_text_error => '<span class="error_msg">Vous n\'avez pas fournit le mot de passe actuel !</span>',
pPassword_password => 'Nouveau mot de passe',
pPassword_password2 => 'Nouveau mot de passe (confirmation)',
pPassword_password_text_error => '<span class="error_msg">Le mot de passe fournit ne correspond pas!<br />Ou est vide!</span>',
pPassword_button => 'Changer le mot de passe',
pPassword_result_error => '<span class="error_msg">Impossible de changer votre mot de passe!</span>',
...
pVacation_result_error => '<span class="error_msg">Impossible de mettre à jour les réglages du répondeur!</span>',
...
pViewlog_result_error => '<span class="error_msg">Impossible de trouver le journal des événements!</span>',
pSendmail_welcome => 'Envoyer un courriel.',
pSendmail_admin => 'De',
pSendmail_to => 'À',
pSendmail_to_text_error => '<span class="error_msg">À est vide ou ce n\'est pas une adresse courriel valide!</span>',
pSendmail_subject => 'Sujet',
pSendmail_subject_text => 'Bienvenue',
pSendmail_body => 'Message',
pSendmail_button => 'Envoyer le message',
pSendmail_result_error => '<span class="error_msg">Erreur lors de l\'envoit du message!</span>',
...
pAdminCreate_domain_domain_text_error => '<span class="error_msg">Le domaine existe déjà!</span>',
pAdminCreate_domain_domain_text_error2 => '<span class="error_msg">Le domaine est non valide!</span>',
...
pAdminCreate_domain_maxquota_text => 'MB<br /> -1 = désactivé | 0 = illimité',
...
pAdminCreate_domain_result_error => '<span class="error_msg">Impossible d\'ajouter le domaine!</span>',
pAdminCreate_domain_result_success => 'Le domaine a été ajouté!',
pAdminDelete_domain_error => '<span class="error_msg">Impossible de supprimer le domain!</span>',
pAdminDelete_alias_domain_error => '<span class="error_msg">Impossible de supprimé cet alias de domaine!</span>',
...
pAdminEdit_domain_maxquota_text => 'MB<br /> -1 = désactivé | 0 = illimité',
...
pAdminEdit_domain_result_error => '<span class="error_msg">Impossible de modifier le domain!</span>',
...
pAdminCreate_admin_username_text_error1 => '<span class="error_msg">Ce n\'est pas une adresse courriel administrateur valide!</span>',
pAdminCreate_admin_username_text_error2 => '<span class="error_msg">Cet adresse courriel administrateur existe déjà ou n\'est pas valide</span>',
pAdminCreate_admin_password => 'Mot de passe',
pAdminCreate_admin_password2 => 'Mot de passe (confirmation)',
pAdminCreate_admin_password_text_error => '<span class="error_msg">Le mot de passe fournit ne correspond pas<br> ou est vide!</span>',
pAdminCreate_admin_button => 'Ajouter un administrateur',
pAdminCreate_admin_result_error => '<span class="error_msg">Impossible d\'ajouter un administrateur!</span>',
...
pAdminEdit_admin_password_text_error => '<span class="error_msg">Le mot de passe fournit ne correspond pas<br /> ou est vide!</span>',
...
pAdminEdit_admin_result_error => '<span class="error_msg">Impossible de modifier l\'administrateur !</span>',
...
pUsersMain_vacationSet => 'La ' . $PALANG['pUsersMenu_vacation'] . ' est activée, cliquer \'' . $PALANG['pUsersMenu_vacation'] . '\' pour ' . $PALANG['edit'] . '/effacer',
...
1 => 'Je serai absent(e) de <date> jusqu\'au <date>.
...
pUsersVacation_result_error => '<span class="error_msg">Impossible de mettre à jour vos paramètres de réponse automatique!</span>',
