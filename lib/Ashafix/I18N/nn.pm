...
pDelete_delete_error => '<span class="error_msg">Kan ikke slette',
pDelete_delete_success => '%s deleted.',
pDelete_postdelete_error => '<span class="error_msg">Unable to remove mailbox ',
pDelete_domain_error => '<span class="error_msg">Dette domenet er ikke ditt',
...
pCreate_alias_address_text_error2 => '<br /><span class="error_msg">Denne epostadressen eksisterer allerede, velg en annen!</span>',
pCreate_alias_address_text_error3 => '<br /><span class="error_msg">Du er over grensen for antall aliaser i ditt domene!</span>',
...
pCreate_alias_goto_text_error => 'Hvor skal eposten videresendes?.<br /><span class="error_msg">Mottakerfeltet er ikke gyldig!</span>',
pCreate_alias_result_error => '<span class="error_msg">Klarte ikke legge til aliaset!</span>',
pCreate_alias_result_success => 'Aliaset er lagt til i alias-tabellen!',
pCreate_alias_catchall_text => 'For å opprette et alias som "mottar alt" bruk "*" som alias.<br />For domene-til-domene videresending bruk "*@domene.tld" som mottaker.',
pEdit_alias_welcome => 'Endre et alias.<br />En mottaker per linje.',
...
pEdit_alias_goto_text_error1 => '<span class="error_msg">Du skrev ikke noe i mottakerfeltet</span>',
pEdit_alias_goto_text_error2 => '<span class="error_msg">E-post adressen er ugyldig: ',
pEdit_alias_domain_error => '<span class="error_msg">Dette er ikke ditt domene: ',
...
pCreate_mailbox_username_text_error1 => '<br /><span class="error_msg">E-postadressen er ugyldig!</span>',
pCreate_mailbox_username_text_error2 => '<br /><span class="error_msg">E-postadressen eksisterer allerede, velg en annen!</span>',
pCreate_mailbox_username_text_error3 => '<br /><span class="error_msg">Du er over grensen for antall e-postkontoer!</span>',
...
pCreate_mailbox_password_text_error => 'Passord for POP3/IMAP<br /><span class="error_msg">Passordene er ikke like!<br />Eller feltet er tomt!</span>'; $PALANG['pCreate_mailbox_name'] = 'Namn',
pCreate_mailbox_name_text => 'Fornavn og etternavn',
pCreate_mailbox_quota => 'Kvote',
pCreate_mailbox_quota_text => 'MB',
pCreate_mailbox_quota_text_error => 'MB<br /><span class="error_msg">Den ønskede kvoten er for høy!</span>',
pCreate_mailbox_active => 'Aktiv',
pCreate_mailbox_mail => 'Opprett epostkonto',
pCreate_mailbox_button => 'Opprett Alias',
pCreate_mailbox_result_error => '<span class="error_msg">Klarte ikke å legge til e-postkontoen!</span>',
...
pEdit_mailbox_password_text_error => '<span class="error_msg">Passordene er ikke like!</span>',
pEdit_mailbox_name => 'Navn',
pEdit_mailbox_name_text => 'Full name',
pEdit_mailbox_quota => 'Kvote',
pEdit_mailbox_quota_text => 'MB',
pEdit_mailbox_quota_text_error => 'MB<br /><span class="error_msg">Kvoten er for høy!</span>',
pEdit_mailbox_domain_error => '<span class="error_msg">Dette domenet er ikke ditt: ',
pEdit_mailbox_button => 'Endre E-postkonto',
pEdit_mailbox_result_error => '<span class="error_msg">Klarte ikke å skifte passord</span>',
pPassword_welcome => 'Endre Passord.',
pPassword_admin => 'Brukernavn',
pPassword_admin_text_error => '<span class="error_msg">Brukarnavnet eksisterer ikke</span>',
pPassword_password_current => 'Eksisterende passord',
pPassword_password_current_text_error => '<span class="error_msg">Oppgi det eksisterende passordet!</span>',
pPassword_password => 'Nytt passord',
pPassword_password2 => 'Nytt passord (igjen)',
pPassword_password_text_error => '<span class="error_msg">Passordene er ikke like!<br />Eller feltet er tomt!</span>',
pPassword_button => 'Endre Passord',
pPassword_result_error => '<span class="error_msg">Klarte ikke å endre passord!</span>',
...
pViewlog_button => 'Vis',
pViewlog_result_error => '<span class="error_msg">Fant ikke loggen!</span>',
pSendmail_welcome => 'Send E-post.',
pSendmail_admin => 'Fra',
pSendmail_to => 'Mottaker',
pSendmail_to_text_error => '<span class="error_msg">"Mottaker"-feltet er tomt eller er ugyldig!</span>',
pSendmail_subject => 'Emne',
pSendmail_subject_text => 'Velkommen',
pSendmail_body => 'Melding',
pSendmail_button => 'Send beskjed',
pSendmail_result_error => '<span class="error_msg">Klarte ikke å opprette e-postkontoen!</span>',
...
pAdminCreate_domain_domain_text_error => '<span class="error_msg">Domenet eksisterer!</span>',
...
pAdminCreate_domain_maxquota_text => 'MB<br /> -1 = deaktivere | 0 = ubegrenset',
...
pAdminCreate_domain_result_error => '<span class="error_msg">Klarte ikke å legge til domenet!</span>',
...
pAdminEdit_domain_maxquota_text => 'MB<br /> -1 = deaktivere | 0 = ubegrenset',
...
pAdminEdit_domain_result_error => '<span class="error_msg">Klarte ikke å oppdatere domenet!</span>',
...
pAdminCreate_admin_username_text_error1 => 'E-postadresse<br /><span class="error_msg">Administrator er ikke gyldig adresse!</span>',
pAdminCreate_admin_username_text_error2 => 'E-postadresse<br /><span class="error_msg">Administratoren eksisterer eller er ikke gyldig</span>'; $PALANG['pAdminCreate_admin_password'] = 'Passord',
pAdminCreate_admin_password2 => 'Passord (igjen)',
pAdminCreate_admin_password_text_error => '<span class="error_msg">Passordene er ikke like!<br />Eller feltene er tomme!</span>',
pAdminCreate_admin_button => 'Legg til en administrator',
pAdminCreate_admin_result_error => '<span class="error_msg">Klarte ikke å legge til administratoren!</span>',
...
pAdminEdit_admin_password_text_error => '<span class="error_msg">Passordene er ikke like!<br />Eller feltene er tomme!</span>',
...
1 => 'Jeg vil være utilgjengelig fra <date> til <date>.
...
pUsersVacation_result_error => '<span class="error_msg">Klarte ikke å oppdatere dine autosvar-instillinger!</span>',
