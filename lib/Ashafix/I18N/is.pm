...
pDelete_delete_error => '<span class="error_msg">Get ekki eytt færslunni ',
pDelete_delete_success => '%s deleted.',
pDelete_postdelete_error => '<span class="error_msg">Unable to remove mailbox ',
pDelete_domain_error => '<span class="error_msg">Þetta er ekki þitt lén ',
...
pCreate_alias_welcome => 'Útbúa nýjan alias fyrir þitt lén.'; $PALANG['pCreate_alias_address'] = 'Alias',
pCreate_alias_address_text_error1 => '<br /><span class="error_msg">Aliasinn er ekki í lagi!</span>',
pCreate_alias_address_text_error2 => '<br /><span class="error_msg">Þetta pósthólf er nú þegar til, veldu annað!</span>',
pCreate_alias_address_text_error3 => '<br /><span class="error_msg">Þú hefur stofnað þann fjölda pósthólfa sem þú hefur heimild til!</span>',
...
pCreate_alias_goto_text_error => 'Þangað sem pósturinn þarf að sendast.<br /><span class="error_msg">Til línan er ekki gild!</span>',
pCreate_alias_result_error => '<span class="error_msg">Get ekki bætt við alias í alias töflu!</span>',
pCreate_alias_result_success => 'Nýr alias hefur verið bætt við alias töfluna!',
pCreate_alias_catchall_text => 'Til að útbúa alias fyrir öll netföng í léninu, þá geturðu útbúið "*" alias.<br />Til að áframsenda með alias á annað lén eða pósthólf, notaðu "*@domain.tld í til.',
pEdit_alias_welcome => 'Breyta alias í léninu.<br />Ein færsla í einu.',
pEdit_alias_address => 'Alias',
pEdit_alias_address_error => '<span class="error_msg">Get ekki fundið aliasinn!</span>',
pEdit_alias_goto => 'To',
pEdit_alias_active => 'Active',
pEdit_alias_goto_text_error1 => '<span class="error_msg">þú gafst ekki upp neitt í Til</span>',
pEdit_alias_goto_text_error2 => '<span class="error_msg">Pósthólfið sem þú reynir að nota er ekki til: ',
pEdit_alias_domain_error => '<span class="error_msg">Þú átt ekki þetta lén: ',
...
pEdit_alias_result_error => '<span class="error_msg">Get ekki breytt alias!</span>',
pCreate_mailbox_welcome => 'Create a new local mailbox for your domain.',
pCreate_mailbox_username => 'notandanafn',
pCreate_mailbox_username_text_error1 => '<br /><span class="error_msg">Netfangið er ekki til!</span>',
pCreate_mailbox_username_text_error2 => '<br /><span class="error_msg">Þetta pósthólf er til núþegar, veldu þér annað!</span>',
pCreate_mailbox_username_text_error3 => '<br /><span class="error_msg">Þú hefur stofnað þau póstholf sem þú hefur heimild til!</span>',
...
pCreate_mailbox_password_text_error => 'Lykilorð fyrir POP3/IMAP<br /><span class="error_msg">Lykilorðin sem þú skrifaðir inn passa ekki saman!<br />Eða þú gafst ekkert lykilorð upp!</span>',
pCreate_mailbox_name => 'Nafn',
pCreate_mailbox_name_text => 'Fullt nafn',
pCreate_mailbox_quota => 'kvóti',
pCreate_mailbox_quota_text => 'MB',
pCreate_mailbox_quota_text_error => 'MB<br /><span class="error_msg">Kvótinn sem þú skilgreindir er meiri en heimild þín gefur!</span>',
pCreate_mailbox_active => 'Virkur',
pCreate_mailbox_mail => 'Stofna pósthólf',
pCreate_mailbox_button => 'bæta við pósthólfi',
pCreate_mailbox_result_error => '<span class="error_msg">Get ekki bætt við pósthólfi í mailbox töfluna!</span>',
...
pEdit_mailbox_username_error => '<span class="error_msg">Finn ekki pósthólfið!</span>',
pEdit_mailbox_password => 'Nýtt lykilorð',
pEdit_mailbox_password2 => 'Nýja lykilorðið aftur',
pEdit_mailbox_password_text_error => '<span class="error_msg">Lykilorðið sem þú skrifaðir inn passar ekki saman!</span>',
pEdit_mailbox_name => 'Nafn',
pEdit_mailbox_name_text => 'Full name',
pEdit_mailbox_quota => 'kvóti',
pEdit_mailbox_quota_text => 'MB',
pEdit_mailbox_quota_text_error => 'MB<br /><span class="error_msg">Kvótinn sem þú skilgreindir er of hár fyrir heimildina þína!</span>',
pEdit_mailbox_domain_error => '<span class="error_msg">Þetta lén er ekki á þínum vegum: ',
pEdit_mailbox_button => 'Breyta pósthólfi',
pEdit_mailbox_result_error => '<span class="error_msg">Get ekki breytt lykilorðinu!</span>',
pPassword_welcome => 'Breyta auðkenninu þínu til að tengjast.',
pPassword_admin => 'Tengjast',
pPassword_admin_text_error => '<span class="error_msg">Auðkennið sem þú gafst upp, passar ekki við pósthólfið!</span>',
pPassword_password_current => 'gamla lykilorðið',
pPassword_password_current_text_error => '<span class="error_msg">Þú gafst ekki upp núverandi lykilorð þitt!</span>',
pPassword_password => 'Nýtt lykilorð',
pPassword_password2 => 'Nýtt lykilorð (aftur)',
pPassword_password_text_error => '<span class="error_msg">Lykilorðin sem þú gafst upp passa ekki saman!<br />Eða þú gefur upp tómt lykilorð!</span>',
pPassword_button => 'Breyta lykilorði',
pPassword_result_error => '<span class="error_msg">Get ekki breytt lykilorði!</span>',
...
pViewlog_result_error => '<span class="error_msg">Get ekki fundið log skráningu!</span>',
pSendmail_welcome => 'sendu tölvupóst.',
pSendmail_admin => 'frá',
pSendmail_to => 'til',
pSendmail_to_text_error => '<span class="error_msg">til er tómt eða ekki uppgefið gilt netfang!</span>',
pSendmail_subject => 'Efni bréfs',
pSendmail_subject_text => 'Velkomin',
pSendmail_body => 'Meginmál',
pSendmail_button => 'Senda skilaboð',
pSendmail_result_error => '<span class="error_msg">Get ekki búið til nýtt pósthólf!</span>',
...
pAdminCreate_domain_domain_text_error => '<span class="error_msg">Lénið er til nú þegar!</span>',
...
pAdminCreate_domain_maxquota_text => 'MB<br /> -1 = óvirkt | 0 = ótakmarkað',
...
pAdminCreate_domain_result_error => '<span class="error_msg">Get ekki bætt við léni!</span>',
...
pAdminEdit_domain_maxquota_text => 'MB<br /> -1 = óvirkt | 0 = ótakmarkað',
...
pAdminEdit_domain_result_error => '<span class="error_msg">Get ekki breytt léni!</span>',
...
pAdminCreate_admin_username_text_error1 => 'Póstfang<br /><span class="error_msg">Kerfisstjóri er ekki rétt póstfang!</span>',
pAdminCreate_admin_username_text_error2 => 'Póstfang<br /><span class="error_msg">Kerfisstjóri er til nú þegar eða er ekki leyfilegt</span>',
pAdminCreate_admin_password => 'Lykilorð',
pAdminCreate_admin_password2 => 'Lykilorð (aftur)',
pAdminCreate_admin_password_text_error => '<span class="error_msg">Lykilorðið sem þú gafst upp passar ekki!<br />Eða var tómt!</span>',
pAdminCreate_admin_button => 'Bæta við kerfisstjóra',
pAdminCreate_admin_result_error => '<span class="error_msg">Get ekki bætt við kerfisstjóra!</span>',
...
pAdminEdit_admin_password_text_error => '<span class="error_msg">Lykilorðið sem þú gafst upp passar ekki!<br />Eða var tómt!</span>',
pAdminEdit_admin_active => 'Virkt',
pAdminEdit_admin_super_admin => 'Super admin',
pAdminEdit_admin_button => 'Breyta kerfisstjóra',
pAdminEdit_admin_result_error => '<span class="error_msg">Get ekki breytt kerfisstjóra!</span>',
...
1 => 'Ég er ekki við frá <date> og til <date>.  I will be away from <date> until <date>.
...
pUsersVacation_result_error => '<span class="error_msg">Get ekki uppfært sjálfvirk skilaboð þín!</span>',
