...
cancel => 'Cancel',
save => 'Save',
confirm => 'Da li ste sigurni da želite ovo pobrisati?\n',
confirm_domain => 'Da li ste sigurni da želite pobrisati sve zapise za tu domenu? Zapisi ce biti zauvijek pobrisani!\n',
...
pLogin_username => 'Korisničko ime (adresa e-pošte)',
...
pMenu_create_mailbox => 'Dodaj poštanski ormarić',
pMenu_fetchmail => 'Fetch Email',
pMenu_sendmail => 'Pošlji e-poštu',
pMenu_password => 'Lozinka',
pMenu_viewlog => 'Pregledaj zapis',
pMenu_logout => 'Odjava',
pMain_welcome => 'Dobrodošli u Postfix Admin!',
pMain_overview => 'Izlistaj aliase i poštanske ormariće. Tu ih možete uređivati/brisati.',
pMain_create_alias => 'Stvori novi alias za domenu.',
pMain_create_mailbox => 'Stvori novi poštanski ormarić za domenu.',
pMain_sendmail => 'Pošali e-poštu u jedan od novostvorenih poštanskih ormarića.',
...
pOverview_left_arrow => 'Prijašnja stranica',
pOverview_alias_domain_title => ':: Domain Aliases',
pOverview_alias_title => ':: Alias',
pOverview_mailbox_title => ':: Poštanski ormarići',
...
pOverview_alias_mailbox_count => 'Poštanski ormarići',
...
pOverview_get_mailboxes => 'Poštanski ormarići',
pOverview_get_quota => 'Kvota za poštanske ormariće (MB)',
...
pDelete_domain_error => 'Izabrana domena nije pod vašim nadzorom ',
...
pCreate_alias_address_text_error2 => 'Ova adresa e-pošte već postoji, molimo izaberite drugu!',
pCreate_alias_address_text_error3 => 'Postigli ste maksimalan broj vaših aliasa!',
pCreate_alias_goto => 'Za',
pCreate_alias_active => 'Active',
pCreate_alias_button => 'Dodaj alias',
pCreate_alias_goto_text => 'Kuda poslati e-poštu.',
...
pCreate_alias_catchall_text => 'Ukoliko želite stvoriti "sveprimajući" alias, upotrijebite "*" umjesto aliasa. Za preusmjeravanje iz domene na domenu, upotrijebite "*@domena.tld" u "Za" polju.',
...
pEdit_alias_goto_text_error1 => 'U polje "Za" niste unijeli ništa!',
pEdit_alias_goto_text_error2 => 'Adresa e-pošte, koju ste unijeli nije pravilna: ',
pEdit_alias_domain_error => 'Izbrana domena nije pod vašim nadzorom: ',
...
pCreate_mailbox_welcome => 'Stvori novi poštanski ormarić za izbranu domenu.',
pCreate_mailbox_username => 'Korisničko ime',
pCreate_mailbox_username_text_error1 => 'Adresa e-pošte nije pravilna!',
pCreate_mailbox_username_text_error2 => 'Ova adresa e-pošte već postoji, molimo izaberite drugu!',
pCreate_mailbox_username_text_error3 => 'Dostigli ste vaš limit poštanskih ormarića!',
...
pCreate_mailbox_password_text_error => 'Unešene lozinke se ne podudaraju ili su prazne!',
pCreate_mailbox_name => 'Ime',
pCreate_mailbox_name_text => 'Puno ime',
pCreate_mailbox_quota => 'Kvota',
pCreate_mailbox_quota_text => 'MB',
pCreate_mailbox_quota_text_error => 'Unešena kvota je prevelika!',
pCreate_mailbox_active => 'Aktivan',
pCreate_mailbox_mail => 'Stvori poštanski ormarić',
pCreate_mailbox_button => 'Dodaj poštanski ormarić',
pCreate_mailbox_result_error => 'Poštanski ormarić nije moguče stvoriti!',
pCreate_mailbox_result_success => 'Poštanski ormarić je uspješno stvoren!',
...
pEdit_mailbox_welcome => 'Uredi poštanski ormarić za domenu.',
pEdit_mailbox_username => 'Korisničko ime',
pEdit_mailbox_username_error => 'Poštanski ormarić nije bilo moguče naći!',
pEdit_mailbox_password => 'Nova lozinka',
pEdit_mailbox_password2 => 'Nova lozinka (ponovi)',
pEdit_mailbox_password_text_error => 'Unešene lozinke se ne podudaraju!',
pEdit_mailbox_name => 'Ime',
pEdit_mailbox_name_text => 'Full name',
pEdit_mailbox_quota => 'Kvota',
pEdit_mailbox_quota_text => 'MB',
pEdit_mailbox_quota_text_error => 'Unešena kvota je prevelika!',
pEdit_mailbox_domain_error => 'Izbrana domena nije pod vašim nadzorom: ',
pEdit_mailbox_button => 'Uredi poštanski ormarić',
pEdit_mailbox_result_error => 'Poštanski ormarić nije bilo moguče promjeniti!',
pPassword_welcome => 'Promijeni lozinku.',
pPassword_admin => 'Korisnicko ime',
pPassword_admin_text_error => 'Korisničko ime se ne podudara sa poštanskim ormarićem!',
...
pPassword_password_text_error => 'Unešene lozinke se ne podudaraju ili su prazne!',
pPassword_button => 'Promijeni lozinku',
pPassword_result_error => 'Lozinku nije bilo moguče promijeniti!',
pPassword_result_success => 'Lozinka je uspješno promijenjena!',
...
pSendmail_welcome => 'Pošlji e-poštu.',
pSendmail_admin => 'Od',
pSendmail_to => 'Za',
pSendmail_to_text_error => 'Polje "Za" ne sadrži valjanu adresu e-pošte!',
pSendmail_subject => 'Subjekt',
pSendmail_subject_text => 'Dobrodošli!',
pSendmail_body => 'Tekst',
pSendmail_button => 'Pošalji poruku',
pSendmail_result_error => 'Poštanski ormarić nije bilo moguče stvoriti!',
pSendmail_result_success => 'Poštanski ormarić je uspješno stvoren!',
pAdminMenu_list_admin => 'Lista administratora',
pAdminMenu_list_domain => 'Lista domena',
pAdminMenu_list_virtual => 'Lista aliasa in poštanskih ormarića',
...
pAdminMenu_create_mailbox => 'Dodaj poštanski ormarić',
...
pAdminList_domain_mailboxes => 'Poštanski ormarići',
...
pAdminList_virtual_alias_mailbox_count => 'Poštanski ormarići',
...
pAdminCreate_domain_domain_text_error => 'Unešena domena već postoji!',
...
pAdminCreate_domain_mailboxes => 'Poštanski ormarići',
...
pAdminCreate_domain_backupmx => 'Poslužitelj e-pošte je sekundarni MX',
...
pAdminEdit_domain_mailboxes => 'Poštanski ormarići',
...
pAdminEdit_domain_backupmx => 'Poslužitelj e-pošte je sekundarni MX',
...
pAdminCreate_admin_username_text => 'Adresa e-pošte',
pAdminCreate_admin_username_text_error1 => 'Administrator nije valjana adresa e-pošte!',
...
pAdminCreate_admin_password_text_error => 'Unešene lozinke se ne podudaraju ili su prazne!',
pAdminCreate_admin_button => 'Dodaj administratora',
pAdminCreate_admin_result_error => 'Administratora nije bilo moguće dodati!',
pAdminCreate_admin_result_success => 'Admininstrator je uspješno dodan',
...
pAdminEdit_admin_password_text_error => 'Unešene lozinke se ne podudaraju ili su prazne!',
...
pUsersLogin_welcome => 'Korisnici poštanskih ormarića ukoliko želite promjeniti lozinku ili aliase.',
pUsersLogin_username => 'Prijava (adresa e-pošte)',
pUsersLogin_password => 'Lozinka',
pUsersLogin_button => 'Prijava',
pUsersLogin_username_incorrect => 'Korisničko ime nije pravilno! Morate upotrijebiti adresu vaše e-pošte!',
...
pUsersMain_edit_alias => 'Promijenite preusmjerenje na drugu adresu e-pošte.',
pUsersMain_password => 'Promijenite lozinku.',
pUsersVacation_welcome => 'Ovdje možete promijeniti obvijest o odsutnosti.',
...
pUsersVacation_result_error => 'Nemoguće promijeniti vaše postavke o odsutnosti!',
...
pCreate_dbLog_createmailbox => 'stvori poštanski ormarić',
pCreate_dbLog_createalias => 'stvori alias',
pDelete_dbLog_deletealias => 'pobriši alias',
pDelete_dbLog_deletemailbox => 'pobriši poštanski ormarić',
pEdit_dbLog_editactive => 'promijeni stanje aktivnosti',
pEdit_dbLog_editalias => 'uredi alias',
pEdit_dbLog_editmailbox => 'uredi poštanski oramrić',
pSearch => 'traži',
pSearch_welcome => 'Traži: ',
